...
const FALLBACK = {
  settings: {
    ...
    priceMax: 25000,
    about: {
      en: `Quick story: I was born in Venezuela and made aliyah as a teenager, and I pretty much fell for Jerusalem on day one.\nI caught the real-estate bug young, and now it's what I do full-time. I'll treat your apartment hunt like I'm finding a home for a friend (by the end, you usually are one). Expect straight answers, fast replies, and someone who actually knows the city block by block: which buildings get the good light, which streets stay quiet on Shabbat.\nRenting or buying, in English, Hebrew or Spanish. Just message me and let's find your place.`,
      he: `סיפור קצר: נולדתי בוונצואלה ועליתי לארץ כנער, והתאהבתי בירושלים פחות או יותר מהיום הראשון.\nאת החיידק של הנדל"ן תפסתי צעיר, והיום זו העבודה שלי במשרה מלאה. אני מתייחס לחיפוש הדירה שלכם כאילו אני מוצא בית לחבר (ובסוף, בדרך כלל, אתם באמת נהיים חברים). תקבלו תשובות ישירות, מענה מהיר, ומישהו שבאמת מכיר את העיר בניין-בניין: איזה בניין מקבל אור טוב ואיזה רחוב נשאר שקט בשבת.\nלהשכרה או לקנייה, באנגלית, עברית או ספרדית. פשוט שלחו לי הודעה ונמצא את המקום שלכם.`,
      es: `Una historia rápida: nací en Venezuela e hice aliá siendo adolescente, y me enamoré de Jerusalén casi desde el primer día.\nMe picó el gusanillo del inmobiliario muy joven, y hoy me dedico a esto a tiempo completo. Vivo tu búsqueda de piso como si buscara casa para un amigo (y al final, normalmente lo eres). Tendrás respuestas claras, contestación rápida y alguien que conoce la ciudad calle por calle: qué edificios tienen mejor luz y qué calles quedan tranquilas en Shabat.\nAlquilar o comprar, en inglés, hebreo o español. Escríbeme y encontremos tu lugar.`,
    },
  },
  listings: [],
}
