...
const dict = {
  en: {
    ...
    hero: {
      ...
      sub: "I'm Moshe Benzadon. I help you find the right apartment, negotiate the deal, check every line of the contract with the owner, and hand you the keys — so renting in Jerusalem feels effortless.",
    ...
    about: {
      ...
      p1: 'I’m Moshe Benzadon, a Jerusalem real-estate agent focused on long-term apartment rentals — and home sales. I grew up around this city and I know its neighborhoods, its buildings and its rhythms.',
      ...
      portraitAlt: 'Moshe Benzadon, Jerusalem real-estate agent',
      replaceNote: '',
      cta: 'Message Moshe',
  ...
  he: {
    ...
    hero: {
      ...
      sub: 'אני משה בן זדון. אעזור לך למצוא את הדירה הנכונה, אנהל עבורך את המשא ומתן, אבדוק כל שורה בחוזה מול בעל הבית ואמסור לך את המפתחות — כך שהשכרת דירה בירושלים תרגיש פשוטה.',
    ...
    about: {
      ...
      p1: 'אני משה בן זדון, סוכן נדל״ן בירושלים המתמקד בהשכרת דירות לטווח ארוך — וגם במכירת בתים. גדלתי סביב העיר הזו ואני מכיר את השכונות, הבניינים והקצב שלה.',
      ...
      portraitAlt: 'משה בן זדון, סוכן נדל״ן בירושלים',
      replaceNote: '',
  ...
  es: {
    ...
    hero: {
      eyebrow: 'Jerusalén · Alquileres de larga duración y ventas',
      title1: 'Tu hogar en Jerusalén,',
      title2: 'gestionado de principio a fin.',
      sub: 'Soy Moshe Benzadon. Te ayudo a encontrar el apartamento adecuado, negocio el trato, reviso cada línea del contrato con el propietario y te entrego las llaves — para que alquilar en Jerusalén sea sencillo.',
    ...
    about: {
      ...
      p1: 'Soy Moshe Benzadon, agente inmobiliario en Jerusalén centrado en alquileres de larga duración — y venta de viviendas. Crecí en torno a esta ciudad y conozco sus barrios, sus edificios y su ritmo.',
      ...
      portraitAlt: 'Moshe Benzadon, agente inmobiliario en Jerusalén',
      replaceNote: '',
