...
const dict = {
  en: {
    ...
    hero: {
      ...
      title1: 'Rentals in Jerusalem,',
      title2: 'the hard part, handled.',
      sub: 'I find the apartment, negotiate the price and check every line of the contract — then you sign directly with the owner.',
    ...
    stats: { range: 'Monthly rent range', neighborhoods: 'Jerusalem neighborhoods', service: 'Search to contract', languages: 'English · Hebrew · Spanish' },
    rentals: {
    ...
    sales: {
      ...
      p3d: 'From the first viewing through the negotiation to the notary, I’m with you at every step.',
    ...
    services: {
      ...
      items: [
        ...
        { t: 'Check the contract', d: 'I go through every clause of the lease with you so you know exactly what you’re agreeing to — no surprises.' },
        { t: 'Sign with the owner', d: 'The lease is directly between you and the owner. I make sure it’s fair and clear — then you sign with confidence.' },
      ],
    },
    about: {
      eyebrow: 'About Moshe',
    ...
    pages: {
      ...
      services: { title: 'How I help you, step by step', sub: 'From the first search to a contract you can trust — one agent who’s on your side.' },
    ...
    home: {
      ...
      salesText: 'Beyond rentals, I also handle home sales across Jerusalem — from finding the right property through to the notary.',
  ...
  he: {
    ...
    hero: {
      ...
      title1: 'דירות להשכרה בירושלים,',
      title2: 'החלק הקשה — עליי.',
      sub: 'אני מוצא את הדירה, מנהל את המשא ומתן ובודק כל סעיף בחוזה — ואז אתם חותמים ישירות מול בעל הבית.',
    ...
    stats: { range: 'טווח שכר דירה חודשי', neighborhoods: 'שכונות בירושלים', service: 'מחיפוש ועד חוזה', languages: 'אנגלית · עברית · ספרדית' },
    rentals: {
      eyebrow: 'זמין עכשיו',
    ...
    sales: {
      ...
      p3: 'ליווי מלא בעסקה',
      p3d: 'מהצפייה הראשונה ועד עורך הדין, אני איתכם בכל שלב.',
    ...
    services: {
      ...
      items: [
        ...
        { t: 'לבדוק את החוזה', d: 'אני עובר איתכם על כל סעיף בחוזה כדי שתדעו בדיוק על מה אתם חותמים — בלי הפתעות.' },
        { t: 'לחתום מול בעל הבית', d: 'החוזה הוא ישירות ביניכם לבין בעל הבית. אני מוודא שהוא הוגן וברור — ואז אתם חותמים בביטחון.' },
      ],
    },
    about: {
      eyebrow: 'אודות משה',
    ...
    pages: {
      ...
      services: { title: 'איך אני עוזר, צעד אחר צעד', sub: 'מהחיפוש הראשון ועד חוזה שאפשר לסמוך עליו — סוכן אחד לצידכם.' },
    ...
    home: {
      ...
      salesText: 'מעבר להשכרות, אני מטפל גם במכירת בתים בכל ירושלים — ממציאת הנכס ועד עורך הדין.',
  ...
  es: {
    ...
    hero: {
      ...
      title2: 'la parte difícil, resuelta.',
      sub: 'Encuentro el apartamento, negocio el precio y reviso cada cláusula del contrato — y luego firmas directamente con el propietario.',
    ...
    stats: { range: 'Rango de alquiler mensual', neighborhoods: 'Barrios de Jerusalén', service: 'De la búsqueda al contrato', languages: 'Inglés · Hebreo · Español' },
    rentals: {
    ...
    sales: {
      ...
      p3d: 'Desde la primera visita hasta el notario, estoy contigo en cada paso.',
    ...
    services: {
      ...
      items: [
        ...
        { t: 'Revisar el contrato', d: 'Repaso cada cláusula del contrato contigo para que sepas exactamente qué estás firmando — sin sorpresas.' },
        { t: 'Firmar con el propietario', d: 'El contrato es directamente entre tú y el propietario. Yo me aseguro de que sea justo y claro, y luego firmas con confianza.' },
      ],
    },
    about: {
      eyebrow: 'Sobre Moshe',
    ...
    pages: {
      ...
      services: { title: 'Cómo te ayudo, paso a paso', sub: 'De la primera búsqueda a un contrato en el que puedes confiar — un solo agente de tu lado.' },
    ...
    home: {
      ...
      salesText: 'Además de alquileres, gestiono la venta de viviendas en toda Jerusalén — desde encontrar la propiedad hasta el notario.',
