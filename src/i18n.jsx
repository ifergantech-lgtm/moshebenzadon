...
const dict = {
  en: {
    ...
    hero: {
      ...
      title2: 'from search to keys.',
      sub: 'The search, the negotiation, the contract — all on me. You just move in.',
  ...
  he: {
    ...
    hero: {
      ...
      title2: 'מהחיפוש ועד המפתח.',
      sub: 'החיפוש, המשא ומתן, החוזה — הכול עליי. אתם פשוט נכנסים לגור.',
  ...
  es: {
    ...
    hero: {
      ...
      title2: 'de la búsqueda a las llaves.',
      sub: 'La búsqueda, la negociación, el contrato — todo de mi cuenta. Tú solo te mudas.',
